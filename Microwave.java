/*
* This program calculates how long a microwave will heat food
 *   based on the food itself and the quantity of it.
*
* @author  Rodas Nega
* @version 1.0
* @since   2022-09-20
...
final class Microwave {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("What lunch do you want to heat
                        "(sub, pizza, or soup): ");
        final String userInput = foodInput.nextLine();
        System.out.println("How many of this lunch item do you
                        "want to heat?: ");
